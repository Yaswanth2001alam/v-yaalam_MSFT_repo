"Timestamp": 2026-02-02T19:52:59.1570757Z,
...
ip route 61.100.0.0/24 Null0 tag 200
...
ipv6 route 2603:1020:1301:2::/64 Null0 tag 200
...
router bgp 8075
   ...
   neighbor VPNV4-VPNV6-SERVER send-community standard extended
   ...
   neighbor 10.3.159.184 description ewa01.str40
   ...
   address-family ipv6
      ...
      neighbor EWA-CLIENTS-IPV6-FAST rcf in EWA_CLIENTS_IPV6_FAST_IN()
...
router general
   control-functions
      ...
      EOF
      code unit OFFLOAD_STATIC_AND_BGP_AGGREGATE
      function OFFLOAD_STATIC_AND_BGP_AGGREGATE()
      {
      if (source_protocol is STATIC and igp.tag is 200) {
      return true;
      } else if (source_protocol is BGP and igp.tag is 9119) {
      return true;
      }
      }
      EOF
...
router kernel
   address-family ipv4
      ...
      software forwarding hardware offload route rcf OFFLOAD_STATIC_AND_BGP_AGGREGATE()
