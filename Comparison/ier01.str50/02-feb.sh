"Timestamp": 2026-02-02T22:34:51.4879731Z,
...
set groups BGP-OVERLOAD policy-options policy-statement <*> term overload-knob then color 10293
...
set groups default_ospf_setup protocols ospf area "<*[1-9]*>" nssa default-lsa default-metric 65000
...
set system extensions extension-service application file agentjunos arguments -insecureHTTPModeEnable=true
...
set system ddos-protection protocols ndpv6 aggregate bandwidth 500
set system ddos-protection protocols ndpv6 aggregate burst 1024
...
set interfaces et-0/0/1 enable
...
set policy-options policy-statement SET-OVERLOAD-ASPATH term implement-overload then as-path-prepend "8075 8075 8075"
set policy-options policy-statement SET-OVERLOAD-ASPATH term implement-overload then next policy
set policy-options policy-statement SET-OVERLOAD-LOCAL-PREF term implement-overload then local-preference 10
...
set policy-options policy-statement SET-OVERLOAD-REJECT term implement-overload then reject
...
set protocols isis overload allow-route-leaking
set protocols isis overload internal-prefixes
set protocols isis overload external-prefixes
